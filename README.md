# football-api
Free Football API providing live scores, match results, fixtures and detailed player &amp; team statistics in JSON format for developers.
